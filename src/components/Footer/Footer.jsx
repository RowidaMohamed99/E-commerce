...
export default function Footer() {
  return <>
  <footer className="bg-slate-100 py-8 mt-10 bottom-0 left-0 right-0 sm:mx-4 md:mx-4 sm:right-0">
    ...
    <div className="flex gap-3 sm:px-4 md:px-4 px-4">
      <input type="Email" placeholder='Email...'
      className="px-3 grid-cols-1  grow py-1 rounded-lg border-2 border-state-400 focus:outline-none focus:border-primary-500  focus:caret-primary-300 text-sm font-semibold" />
      <button className="bg-primary-900 px-3 py-1 hover:bg-primary-600 transition-colors duration-300 focus:outline-none rounded-lg text-white text-sm font-semibold">Share App Link</button>
    </div>
    <div className="flex items-center justify-between py-4 border-y-2 border-slate-300 border-opacity-50">
      <div className="flex items-center gap-5 ">
      <h3>Payment Partener</h3>
